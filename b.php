...
<head>
  ...
  <script type="text/javascript">
        ...
        if(valor==10){
            document.getElementById("b_otros").disabled = false;
            }
            else {
                document.getElementById("b_otros").disabled = true;
                }
        } // Fin_habilitar_c6()
  </script>
          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form autocomplete="off" action="insertar_b.php" method="post" id="myForm2" accept-charset="utf-8">
                           ...
                           <div class="col-md-3">  
                            ...
                            <div class="col-md-3">  
                                <div class="form-group">
                                    ...
                                    <input type="text" name="responsable" id="responsable" class="form-control" readonly value="<?php echo $_SESSION['login_user_sys'];?> ">
                                </div>  
                            </div>      <!-- Fin_Inicio_row_1 -->
                      </div>
                      <h6 class="m-0 font-weight-bold text-primary"><center> b) Caso positivo </center></h6><br>
                      <div class="row"> <!-- Inicio_row_2 -->
                            <div class="col-md-6">  
                                <div class="form-group">
                                    <label><b>22. </b>Los casos confirmados son: </label>
                                    <select id="b_casos" name="b_casos" class="form-control" onchange="habilitar_otro(this.value);">
                          ...
                          <div class="col-md-6">  
                                <div class="form-group">
                                    ...
                                    <input type="text" name="b_otros" id="b_otros" class="form-control" placeholder="Otro confirmado" disabled="">
                                </div>
                            </div>    
                        ...
                        <div class="row"> <!-- Inicio_row_3 -->
                            <div class="col-md-4">  
                                <div class="form-group">
                                    <label><b>23.</b>¿Cuantos confirmados son: </label>
                                </div>
                            </div>    
                            <div class="col-md-2">  
                                <div class="form-group">
                                    <label><b> </b> Alumnos:</label>
                                    <input type="number" name="b_nalumnos" class="form-control" placeholder="#" min=0 value="<?php echo 0;?>">
                                </div>
                            </div>
                           <div class="col-md-2">  
                                <div class="form-group">
                                    <label><b> </b> Docentes: </label>
                                    <input type="number" name="b_ndocentes" class="form-control" placeholder="#" min=0 value="<?php echo 0;?>">
                                </div>
                            </div>
                            <div class="col-md-2">  
                                <div class="form-group">
                                    <label><b> </b> (otro) Trabajador: </label>
                                    <input type="number" name="b_ntescuela" class="form-control" placeholder="#" min=0 value="<?php echo 0;?>">
                                </div>
                            </div>
                            <div class="col-md-2">  
                                <div class="form-group">
                                    <label><b> </b> Padres / Tutor: </label>
                                    <input type="number" name="b_nfamiliar" class="form-control" placeholder="#" min=0 value="<?php echo 0;?>">
                                </div>
                            </div>                     
                      </div>             <!-- Fin_row_3 -->
                      ...
                      <div class="row">       <!-- Inicio_row_4 --> 
                          <div class="col-md-3">
                              <div class="form-group">
                                  <label><b>24. </b> ¿Pertenece a la misma área?</label>
                                  <select id="b_marea" name="b_marea" class="form-control">
                          ...
                          <div class="col-md-9">
                              <div class="form-group">
                                  <label><b>24.1. </b> Comentarios: </label>
                                  <input type="text" name="b_coment_marea" id="b_coment_marea" class="form-control" placeholder=" Si es necesario escribir comentarios..." value=" ">
                      ...
                      <div class="row">     <!-- Inicio_row_5 --> 
                          <div class="col-md-3">
                              <div class="form-group">
                                  <label><b>25. </b> ¿Cuantos son de la misma área?</label>
                                  <input type="number" name="b_narea" id="b_narea" class="form-control" value="<?php echo 0;?>">
                              </div>
                          </div>  
                          <div class="col-md-3">
                              <div class="form-group">
                                  <label><b>26. </b> ¿Cuenta con una prueba que valide el diagnostico positivo? </label>
                                  <select id="b_prueba" name="b_prueba" class="form-control">
                          ...
                          <div class="col-md-3">
                              <div class="form-group">
                                  <label><b>27. </b> ¿Actualmente asisten a la escuela? </label>
                                  <select id="b_aescuela" name="b_aescuela" class="form-control">
                                      <option value="0" selected="">No</option>
                                      <option value="1">Si</option>
                                  </select>
                              </div>
                          ...
                          <div class="col-md-3">
                                <div class="form-group">
                                    <label><b>28. </b> ¿Cuanto iniciaron los sintomas? (o estimación)</label>
                                    <input type="date" name="b_fechasin" class="form-control" required="">
                                </div>
                          </div>
                      </div>                <!-- fin_row_5 --> 
                      ...
                      <div class="row">     <!-- Inicio_row_6 -->
                        <div class="col-md-3">
                                <div class="form-group">
                                    <label><b>29. </b> ¿Cual es su derechohabiencia? </label>
                                    <select id="b_derechohabiencia" name="b_derechohabiencia" class="form-control">
                          ...
                          <div class="col-md-5">
                              <div class="form-group">
                                  <label><b>30. </b> Lugar donde se realizo la prueba:<br><br> </label>
                                  <input type="text" name="lugar_prueba" id="lugar_prueba" class="form-control" placeholder=" Indicar lugar donde se realizo la prueba..." value=" ">
                              </div>
                          </div>

                          <div class="col-md-4">
                              <div class="form-group">
                                  <label><font color="red"><b>* </b> Indicaciones realizadas:<br><br></font></label>
                                  <select id="c_indicaciones" name="b_indicaciones" class="form-control">
                    ...
                    <br><div>
                      <div hidden=""><span style="color:red;">
                     <?php 
                     if($_GET["msj"]=='No_insert') { echo "<script> Swal.fire('No se realizo el registro',':(','error');</script>"; }
                     if($_GET['idsegb']>=1) { echo "<script>Swal.fire('Seguimiento registrado exitosamente :) ','','success'); </script>"; }
                     ?></span></div>
